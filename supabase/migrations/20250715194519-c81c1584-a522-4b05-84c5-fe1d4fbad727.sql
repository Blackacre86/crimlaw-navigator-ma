-- Create chunks table with corrected schema (using UUID for document_id)
...
-- Add foreign key constraint with correct UUID type
...
-- Create match_chunks function with corrected return type
